...
const int ENCRYPTION_IGNITION = 0;
const int ENCRYPTION_SPHERECLIENT = 1;
const int ENCRYPTION_1_26_4 = 2;
const int ENCRYPTION_2_0_0 = 3;
const int ENCRYPTION_3_0_5 = 4;
